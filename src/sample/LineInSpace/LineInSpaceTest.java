...
public class LineInSpaceTest {
    ...
    public LineInSpaceTest() throws IOException {
    }

    private  Question[] question;
    public Question[] fullArray () throws IOException {
        File file = new File("./src/sample/LineInSpace/question_lineInSpace.txt");
        ...
        int i=0;
        Scanner s = new Scanner(new File("./src/sample/LineInSpace/question_lineInSpace.txt"));
        while (i<n) {
