...
public class DefinitionVectorTest {
    ...
    public DefinitionVectorTest() throws IOException {
    }
    String questionFile = "./src/sample/DefinitionVector/question_definitionVector.txt";
    ...
    public Question[] fullArray () throws IOException {
        ...
        int i=0;
        Scanner s = new Scanner(new File(questionFile));
        while (i<n) {
