...
public class CurvesSecondOrderTest {
    ...
    public CurvesSecondOrderTest() throws IOException {
    }

    private  Question[] question;
    public Question[] fullArray () throws IOException {
        File file = new File("./src/sample/CurvesSecondOrder/question_curvesSecondOrder.txt");
        ...
        int i=0;
        Scanner s = new Scanner(new File("./src/sample/CurvesSecondOrder/question_curvesSecondOrder.txt"));
        while (i<n) {
