...
public class PlaneInSpaceTest {
    ...
    public PlaneInSpaceTest() throws IOException {
    }

    private  Question[] question;
    public Question[] fullArray () throws IOException {
        File file = new File("./src/sample/PlaneInSpace/question_planeInSpace.txt");
        ...
        int i=0;
        Scanner s = new Scanner(new File("./src/sample/PlaneInSpace/question_planeInSpace.txt"));
        while (i<n) {
