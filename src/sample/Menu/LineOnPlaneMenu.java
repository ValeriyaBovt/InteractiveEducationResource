...
public class LineOnPlaneMenu {
    ...
    void initialize() {
        ...
        test_button.setOnAction(event -> {
            ...
            openWindow("/sample/LineOnPlane/LineOnPlaneTest.fxml");
        });
        practice_button.setOnAction(event -> {
            practice_button.getScene().getWindow().hide();
            openWindow("/sample/LineOnPlane/lineOnPlanePractice.fxml");
        });
        theory_button.setOnAction(event -> {
            theory_button.getScene().getWindow().hide();
            openWindow("/sample/LineOnPlane/lineOnPlaneTheory.fxml");
        });
