...
public class CurvesSecondOrderMenu {
    ...
    void initialize() {
        ...
        theory_button.setOnAction(event -> {
            ...
            openWindow("/sample/CurvesSecondOrder/curvesSecondOrderTheory.fxml");
        });
        test_button.setOnAction(event -> {
            test_button.getScene().getWindow().hide();
            openWindow("/sample/CurvesSecondOrder/curvesSecondOrderTest.fxml");
        });
