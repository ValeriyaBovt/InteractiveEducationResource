...
public class OperationVectorMenu {
    ...
    void initialize() {
        ...
        test_button.setOnAction(event -> {
            ...
            openWindow("/sample/OperationVector/operationVectorTest.fxml");
        });
       practice_button.setOnAction(event -> {
            practice_button.getScene().getWindow().hide();
            openWindow("/sample/OperationVector/operationVectorPractice.fxml");
        });
        theory_button.setOnAction(event -> {
           theory_button.getScene().getWindow().hide();
            openWindow("/sample/OperationVector/operationVectorTheory.fxml");
        });
