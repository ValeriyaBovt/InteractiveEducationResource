...
public class DeterminantMenu {
    ...
    void initialize() {
        ...
        theory_button.setOnAction(event -> {
            ...
            fileChooser.setInitialFileName("theory");
            ...
            openWindow("/sample/Determinant/determinantTheory.fxml");
        });
        test_button.setOnAction(event -> {
            test_button.getScene().getWindow().hide();
            openWindow("/sample/Determinant/determinantTest.fxml");
        });
        practice_button.setOnAction(event -> {
            practice_button.getScene().getWindow().hide();
            openWindow("/sample/Determinant/determinantPractice.fxml");
        });
