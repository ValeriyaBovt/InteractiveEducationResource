...
public class PlaneInSpaceMenu {
    ...
    void initialize() {
        ...
        practice_button.setOnAction(event -> {
            ...
            openWindow("/sample/PlaneInSpace/planeInSpacePractice.fxml");
        });
       theory_button.setOnAction(event -> {
            theory_button.getScene().getWindow().hide();
            openWindow("/sample/PlaneInSpace/planeInSpaceTheory.fxml");
        });
        test_button.setOnAction(event -> {
            test_button.getScene().getWindow().hide();
            openWindow("/sample/PlaneInSpace/planeInSpaceTest.fxml");
        });
