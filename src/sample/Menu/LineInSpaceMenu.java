...
public class LineInSpaceMenu {
    ...
    void initialize() {
        ...
        practice_button.setOnAction(event -> {
            ...
            openWindow("/sample/LineInSpace/lineInSpacePractice.fxml");
        });
        theory_button.setOnAction(event -> {
            theory_button.getScene().getWindow().hide();
            openWindow("/sample/LineInSpace/lineInSpaceTheory.fxml");
        });
        test_button.setOnAction(event -> {
           test_button.getScene().getWindow().hide();
            openWindow("/sample/LineInSpace/lineInSpaceTest.fxml");
        });
