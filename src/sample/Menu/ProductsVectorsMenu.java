...
public class ProductsVectorsMenu {
    ...
    void initialize() {
        ...
        practice_button.setOnAction(event -> {
            ...
            openWindow("/sample/ProductsVector/productsVectorPractice.fxml");
        });
        test_button.setOnAction(event -> {
            test_button.getScene().getWindow().hide();
            openWindow("/sample/ProductsVector/productsVectorTest.fxml");
        });
        theory_button.setOnAction(event -> {
            theory_button.getScene().getWindow().hide();
            openWindow("/sample/ProductsVector/productsVectorTheory.fxml");
        });
