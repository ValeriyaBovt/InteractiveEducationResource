...
public class BasicDefinitionMenu {
    ...
    void initialize() {
        ...
        test_button.setOnAction(event -> {
            ...
            openWindow("/sample/DefinitionVector/definitionVectorTest.fxml");
        });
        practice_button.setOnAction(event -> {
            practice_button.getScene().getWindow().hide();
            openWindow("/sample/DefinitionVector/definitionVectorPractice.fxml");
        });
       theory_button.setOnAction(event -> {
            theory_button.getScene().getWindow().hide();
            openWindow("/sample/DefinitionVector/definitionVectorTheory.fxml");
        });
